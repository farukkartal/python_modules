...
def distance_center(pos: tuple[float, float, float]) -> float:
    return (math.sqrt(pos[0]**2 + pos[1]**2 + pos[2]**2))


def distance_between(pos1: tuple[float, float, float],
...
def coordinate_system() -> None:
    ...
    distance = distance_center(pos1)
    print(f"Distance to center: {distance:.4f}\n")
    print("Get a second set of coordinates")
    pos2 = get_player_pos()
    dist_between = distance_between(pos1, pos2)
    print(
