...
def track_achievements() -> None:
    ...
    global_ach = set.union(alice_ach, bob_ach, charlie_ach, dylan_ach)
    common_ach = set.intersection(alice_ach, bob_ach, charlie_ach, dylan_ach)
    print(f"All distinct achievements: {global_ach}\n")
    print(f"Common achievements: {common_ach}")
    only_alice = set.difference(alice_ach, bob_ach, charlie_ach, dylan_ach)
    only_bob = set.difference(bob_ach, alice_ach, charlie_ach, dylan_ach)
    only_charlie = set.difference(charlie_ach, alice_ach, bob_ach, dylan_ach)
    only_dylan = set.difference(dylan_ach, alice_ach, bob_ach, charlie_ach)
    ...
    alice_missing = set.difference(full_ach_set, alice_ach)
    bob_missing = set.difference(full_ach_set, bob_ach)
    charlie_missing = set.difference(full_ach_set, charlie_ach)
    dylan_missing = set.difference(full_ach_set, dylan_ach)
